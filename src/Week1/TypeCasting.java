...
public class TypeCasting {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        /** Explicit Narrowing Casting : If you assign a larger data type to a smaller data type then Java cannot convert the data type automatically to the smaller one.
